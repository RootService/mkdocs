...
_OPTIONS_READ=libgd-2.3.1
_FILE_COMPLETE_OPTIONS_LIST=PNG JPEG WEBP TIFF FREETYPE FONTCONFIG RAQM XPM ICONV
...
_OPTIONS_READ=fontconfig-2.13.92
_FILE_COMPLETE_OPTIONS_LIST=DOCS NLS NO_BITMAPS HINTING_NONE HINTING_SLIGHT HINTING_MEDIUM HINTING_FULL
OPTIONS_FILE_SET+=DOCS
OPTIONS_FILE_SET+=NLS
OPTIONS_FILE_SET+=NO_BITMAPS
...
_OPTIONS_READ=freetype2-2.10.4
_FILE_COMPLETE_OPTIONS_LIST=BROTLI CONFIG DEBUG DOCS LONG_PCF_NAMES PNG TABLE_VALIDATION LCD_FILTERING LCD_RENDERING FIX_SIZE_METRICS TT_SIZE_METRICS V38 V40
...
_OPTIONS_READ=oniguruma-6.9.6
_FILE_COMPLETE_OPTIONS_LIST=DOCS EXAMPLES STATISTICS
OPTIONS_FILE_SET+=DOCS
...
_OPTIONS_READ=php80-gd-8.0.2
_FILE_COMPLETE_OPTIONS_LIST=TRUETYPE JIS WEBP X11
...
_OPTIONS_READ=php80-imap-8.0.2
...
_OPTIONS_READ=php80-mbstring-8.0.2
